...
class GatewaySearchResultDialogFragment : DialogFragment(), GatewaySearchResultsAdapter.ItemClickedListener {
    ...
    companion object {
        ...
        fun newInstance(devices: List<Pair<String, String>>): GatewaySearchResultDialogFragment {
            val fragment = GatewaySearchResultDialogFragment()
